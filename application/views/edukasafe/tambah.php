  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card-header">
        <a href="<?=base_url('edukasafe');?>" class="btn btn-info float-right btn-sm"><i class="fas fa-backward"></i> Kembali</a>          
      </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select name="kategori" class="form-control" required>
                <option value="<?= set_value('kategori');?>">Pilihan : <?= set_value('kategori');?></option>
